...
import imgLogo from '../assets/images/00-Footer-sin-redes.jpg';
...
function SideBar({props}){
    ...
    return(
        <React.Fragment>
            ...
            <ul className="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style={{background: "linear-gradient(blue, 10%, pink)"}}>
                ...
                <li className="nav-item active">
                    <Link className="nav-link" to="/">
                        ...
                        <span>Dashboard - Electricidad Belgrano</span></Link>
                </li>
